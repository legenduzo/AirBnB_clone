...
class TestInitArguments(unittest.TestCase):
    ...
    def test_init_with_args(self):
        ...
        new = BaseModel("123", "2022-01-01T12:00:00", "2022-01-01T13:00:00")
        self.assertNotEqual(new.id, "123")
        self.assertNotEqual(new.created_at, datetime(2022, 1, 1, 12, 0, 0))
    ...
    def test_init_with_kwargs(self):
        ...
        self.assertEqual(b.created_at, datetime(2022, 2, 1, 10, 0, 0))
    ...
    def test_init_with_mixed_args_kwargs(self):
        ...
        self.assertEqual(mixed_model.created_at, datetime(2022, 3, 1, 8, 0, 0))
    ...
    def test_init_with_invalid_datetime(self):
        ...
        with self.assertRaises(ValueError):
            ...
            invalid_model = BaseModel(created_at=creation, updated_at=update)
